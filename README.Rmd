...
title: "Supplementary materials for *The Spatial Construal of TIME in Indonesian: Evidence from Language and Gesture*"
...
This repository hosts the dataset and R codes used in the paper submitted to the journal for the linguistic society of Indonesia, [*Linguistik Indonesia*](http://ojs.linguistik-indonesia.org/index.php/linguistik_indonesia), under the title *The Spatial Construal of TIME in Indonesian: Evidence from Language and Gesture*.
